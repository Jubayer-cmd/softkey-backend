...
router.post("/products/create-product", (0, auth_1.default)(common_1.ENUM_USER_ROLE.ADMIN), Product_controller_1.productController.insertIntoDB);
...
router.delete("/products/:id", (0, auth_1.default)(common_1.ENUM_USER_ROLE.ADMIN), Product_controller_1.productController.deleteFromDB);
